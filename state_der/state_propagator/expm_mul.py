...
def expm_multiply(A, B, theta, tol, start=None, stop=None, num=None, endpoint=None):
    """
    ...
    if all(arg is None for arg in (start, stop, num, endpoint)):
        X = _expm_multiply_simple(A, B, tol)
    else:
